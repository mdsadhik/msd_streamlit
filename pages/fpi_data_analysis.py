...
fpi_chart_data['REPORT_DATE_DT'] = fpi_chart_data['REPORT_DATE']
fpi_chart_data['VALUE_K'] = fpi_chart_data['VALUE'] / 100
fpi_chart_data['REPORT_DATE_DT'] = pd.to_datetime(fpi_chart_data['REPORT_DATE_DT'], format='%d-%b-%y', dayfirst=True)
...
fpi_chart_by_latest_date = fpi_chart_data[fpi_chart_data["REPORT_DATE"] == fpi_chart_data.tail(1)['REPORT_DATE'].iloc[0]]
...
bullish_fpi_chart_data = bullish_fpi_chart_data.drop(
    bullish_fpi_chart_data[bullish_fpi_chart_data.VALUE_CHG_PCT <= 0].index)
bearish_fpi_chart_data = fpi_chart_by_latest_date.head(5)
bearish_fpi_chart_data = bearish_fpi_chart_data.drop(
    bearish_fpi_chart_data[bearish_fpi_chart_data.VALUE_CHG_PCT >= 0].index)
...
bullish_col_1.metric(bullish_fpi_chart_data[4:5]['SECTOR'].iloc[0], bullish_fpi_chart_data[4:5]['VALUE_K'].iloc[0],
                     bullish_fpi_chart_data[4:5]['VALUE_CHG_PCT'].iloc[0])
bullish_col_2.metric(bullish_fpi_chart_data[3:4]['SECTOR'].iloc[0], bullish_fpi_chart_data[3:4]['VALUE_K'].iloc[0],
                     bullish_fpi_chart_data[3:4]['VALUE_CHG_PCT'].iloc[0])
bullish_col_3.metric(bullish_fpi_chart_data[2:3]['SECTOR'].iloc[0], bullish_fpi_chart_data[2:3]['VALUE_K'].iloc[0],
                     bullish_fpi_chart_data[2:3]['VALUE_CHG_PCT'].iloc[0])
bullish_col_5.metric(bearish_fpi_chart_data[0:1]['SECTOR'].iloc[0], bearish_fpi_chart_data[0:1]['VALUE_K'].iloc[0],
                     bearish_fpi_chart_data[0:1]['VALUE_CHG_PCT'].iloc[0])
bullish_col_6.metric(bearish_fpi_chart_data[1:2]['SECTOR'].iloc[0], bearish_fpi_chart_data[1:2]['VALUE_K'].iloc[0],
                     bearish_fpi_chart_data[1:2]['VALUE_CHG_PCT'].iloc[0])
bullish_col_7.metric(bearish_fpi_chart_data[2:3]['SECTOR'].iloc[0], bearish_fpi_chart_data[2:3]['VALUE_K'].iloc[0],
                     bearish_fpi_chart_data[2:3]['VALUE_CHG_PCT'].iloc[0])



selected_sector = ['Financial Services', 'Information Technology', 'Power', 'Consumer Services', 'Construction',
                   'Healthcare', 'Realty', 'Oil, Gas & Consumable Fuels']
...
fpi_bar_chart1 = alt.Chart(fpi_chart_data).mark_bar().encode(
    ...
    column=alt.Column('REPORT_DATE_DT:T', title="FPI Investment value "),
    tooltip=[
...
gb = GridOptionsBuilder.from_dataframe(fpi_chart_data)
